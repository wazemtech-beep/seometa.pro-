...
export default function ContactHero() {
  return (
    <section id="contact-hero" className="relative pt-36 pb-24 md:pt-48 md:pb-36 flex flex-col items-center justify-center text-center px-4 overflow-hidden select-none min-h-[520px]">
      ...
      <div className="max-w-[1180px] mx-auto w-full relative z-10 flex flex-col items-center justify-center">
        {/* Main Title: Get in Touch With Us */}
        <motion.h1
        ...
        <motion.p
          ...
          style={{ fontFamily: "'Inter', sans-serif" }}
        >
          Have questions about SEOMeta.pro or need custom AI metadata integration? Fill out the form below or reach out directly!
        </motion.p>
      </div>
    </section>
  );
