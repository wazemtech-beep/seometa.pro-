...
export default function BlogHero() {
  return (
    <section id="blog-hero" className="relative pt-36 pb-24 md:pt-48 md:pb-36 flex flex-col items-center justify-center text-center px-4 overflow-hidden select-none min-h-[520px]">
      {/* Framer Hero Background Image Banner */}
      ...
      <div className="max-w-[1180px] mx-auto w-full relative z-10 flex flex-col items-center justify-center">
        {/* Main Title: Latest Insights & News */}
        <motion.h1
        ...
        <motion.p
          ...
          style={{ fontFamily: "'Inter', sans-serif" }}
        >
          Discover expert tips, AI metadata guides, and microstock SEO strategies to maximize your stock portfolio visibility and earnings.
        </motion.p>
      </div>
    </section>
  );
